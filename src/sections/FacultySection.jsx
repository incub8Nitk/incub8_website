    ...
    <div className="w-full py-12 sm:py-16 px-4">
      ...
      <div className="max-w-3xl mx-auto mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-12">
        {facultyMembers.map((member, index) => (
          <div 
            key={index}
            className="group flex flex-col items-center text-center p-2 bg-slate-800/50 rounded-lg border border-slate-700 hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/20"
          >
            <div className="relative">
              <img
                ...
                className="w-48 h-48 rounded-lg object-cover border-4 border-slate-600 group-hover:border-blue-400 transition-all duration-300 transform group-hover:scale-105"
              />
            </div>
