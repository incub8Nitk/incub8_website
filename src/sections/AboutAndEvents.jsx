  ...
  return (
    <div style={{
      ...
      <section id="gallery" className="relative py-12 sm:py-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-20 mb-6 sm:mb-8">
          <div className="text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-2" style={{
