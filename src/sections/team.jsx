...
const CoreTeamCarousel = () => {
  const teamMembers = [
    ...
    { name: "Dhanush T", role: "Chief Coordinator", image: "public/coreTeam/dhanush.jpg", bio: "A dedicated team member.", linkedin: "https://www.linkedin.com/in/dhanush-t-a6b479206/" },
