    ...
    <>
      <section className="w-full py-14 px-6 md:px-12 lg:px-20 text-white" style={{
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end md:justify-between justify-center md:gap-4 mb-8">
            <div>
              <h2 className="text-5xl text-center md:text-4xl font-semibold mb-2 md:mb-0" style={{ color: 'var(--incub8-sand)' }}>Events</h2>
          ...
          <div className="grid gap-6 md:gap-8 grid-cols-1 md:grid-cols-3 mx-10">
            {top6.map((e, i) => (
